...
<header class="site-header">
  <div class="container header-inner">
    ...
    <div class="header-actions">
      ...
      <button class="icon-btn" aria-label="Wishlist"><svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" stroke-width="2"><path d="M20.8 4.6a5.5 5.5 0 0 0-7.8 0L12 5.7l-1-1.1a5.5 5.5 0 0 0-7.8 7.8l1 1L12 21l7.8-7.8 1-1a5.5 5.5 0 0 0 0-7.8z"/></svg></button>
      <button class="icon-btn" aria-label="Cart"><svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" stroke-width="2"><circle cx="9" cy="21" r="1"/><circle cx="20" cy="21" r="1"/><path d="M1 1h4l2.7 13.4a2 2 0 0 0 2 1.6h9.7a2 2 0 0 0 2-1.6L23 6H6"/></svg><span class="badge">3</span></button>
...
<div class="search-overlay" id="searchOverlay">
  ...
  <div class="search-box">
    <input type="text" placeholder="Cari raket, sepatu, grip..." />
    <div class="search-suggest">
      <span>POPULAR SEARCH</span>
      <div class="search-tags">
        <a href="product.html">Future 66 III</a>
        <a href="product.html">Dragon Z Attack</a>
        <a href="product.html">Magnum X10</a>
        <a href="product.html">Hybrid Pro</a>
        <a href="product.html">Grip Handuk</a>
      </div>
    </div>
  </div>
</div>`;
  ...
  <div class="container">
    <div class="footer-grid">
      ...
      <div class="footer-col">
        <h5>COMPANY</h5>
        <ul>
          <li><a href="jp-store.html">About Us</a></li>
          <li><a href="jp-store.html#tech">Technology</a></li>
          <li><a href="jp-store.html#timeline">Our Journey</a></li>
...
<aside class="floating-side" id="floatSide">
  ...
  <div class="fs-slider" id="fsSlider">
    <a href="product.html" class="fs-slide active"><img src="assets/unggulan2.jpg" alt="Dragon Z" /></a>
    <a href="product.html" class="fs-slide"><img src="assets/unggulan3.jpg" alt="Magnum X10" /></a>
    <a href="product.html" class="fs-slide"><img src="assets/future66.png" alt="Future 66" /></a>
    <a href="product.html" class="fs-slide"><img src="assets/feed1.jpg" alt="Hybrid Pro" /></a>
    <a href="product.html" class="fs-slide"><img src="assets/feed2.jpg" alt="RN-8000" /></a>
  </div>
  <div class="fs-caption">NEW ARRIVAL</div>
</aside>
<a href="https://wa.me/6281234567890" class="wa-float" aria-label="WhatsApp"><svg viewBox="0 0 24 24" width="28" height="28" fill="white"><path d="M20 12a8 8 0 1 1-3.4-6.5l1.7-1.7A10 10 0 1 0 22 12h-2zm-3.6 1.8c-.3-.2-1.8-.9-2-1s-.5-.2-.7.2-.8 1-1 1.2-.4.2-.7 0-1.2-.4-2.3-1.4c-.9-.8-1.4-1.7-1.6-2s0-.4.1-.6.3-.3.4-.5.2-.3.3-.5 0-.4 0-.5l-.7-1.8c-.2-.4-.4-.4-.6-.4h-.5c-.2 0-.5 0-.7.3s-.9 1-.9 2.3.9 2.7 1 2.9 1.8 2.9 4.5 4 3 .7 3.6.7 1.7-.7 2-1.4.3-1.3.2-1.4-.2-.2-.5-.4z"/></svg></a>`;
